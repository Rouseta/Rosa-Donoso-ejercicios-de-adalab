    ...
    <div>
      <form className="form" onSubmit={handleForm}>
        ...
        <div className="form">
          ...
          {/* name */}
          <InputGroupText className="input-text" type="text" name={name} id="name" placeholder="María García" value={name}
        ...
        <Preview name={name} email={email} region={region} paymentType="" renderPaymentTypeText={renderPaymentTypeText} />

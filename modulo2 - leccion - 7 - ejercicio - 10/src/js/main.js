...
//     console.log(`El dato ${data} está en la posición ${items[data]} y es de tipo  ${typeof(data)}`);
// };
for (let data = 0; data < items.length; data++) {
    console.log(`El dato ${items[data]} está en la posición ${data} y es de tipo  ${typeof (items[data])}`)
};
